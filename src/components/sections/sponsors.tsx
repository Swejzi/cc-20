      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            <span className="text-purple-500">Sponzoři</span> konference
          </h2>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {sponsors.platinum.map((sponsor, index) => (
              <div 
                key={index}
                className="bg-purple-900/20 backdrop-blur-sm rounded-xl border border-purple-500/20 p-8 flex items-center justify-center h-48"
              >
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {sponsors.gold.map((sponsor, index) => (
              <div 
                key={index}
                className="bg-purple-900/20 backdrop-blur-sm rounded-xl border border-purple-500/20 p-6 flex items-center justify-center h-36"
              >
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {sponsors.silver.map((sponsor, index) => (
              <div 
                key={index}
                className="bg-purple-900/20 backdrop-blur-sm rounded-xl border border-purple-500/20 p-4 flex items-center justify-center h-28"
              >
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
            {sponsors.bronze.map((sponsor, index) => (
              <div 
                key={index}
                className="bg-purple-900/20 backdrop-blur-sm rounded-xl border border-purple-500/20 p-3 flex items-center justify-center h-24"
              >
